...
object ImagePicker {
    ...
    private var type: String = "IMAGE_PICKER_TYPE"
     ...
     * */
    @JvmStatic
    fun type(type: String): ImagePicker {
        pickHelper.type = type
        return this
    }
    ...
    interface OnPickImageResultListener {
        fun onImageResult(type: String, imageItems: ArrayList<ImageItem>)
    }
}
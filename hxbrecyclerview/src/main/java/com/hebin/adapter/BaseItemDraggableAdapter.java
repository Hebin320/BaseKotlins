...
import com.hebin.adapter.listener.OnItemDragListener;
import com.hebin.R;
...
public abstract class BaseItemDraggableAdapter<T, K extends BaseViewHolder> extends BaseQuickAdapter<T, K> {
    ...
    protected com.hebin.adapter.listener.OnItemSwipeListener mOnItemSwipeListener;
     ...
     * You should attach {@link ItemTouchHelper} which construct with {@link com.hebin.adapter.callback.ItemDragAndSwipeCallback} to the Recycler when you enable this.
     */
    ...
    public void setOnItemSwipeListener(com.hebin.adapter.listener.OnItemSwipeListener listener) {

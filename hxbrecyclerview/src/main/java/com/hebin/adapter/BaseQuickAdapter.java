...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    private com.hebin.adapter.loadmore.LoadMoreView mLoadMoreView = new com.hebin.adapter.loadmore.SimpleLoadMoreView();
    ...
    private com.hebin.adapter.animation.BaseAnimation mCustomAnimation;
    private com.hebin.adapter.animation.BaseAnimation mSelectAnimation = new com.hebin.adapter.animation.AlphaInAnimation();
    //header footer
     ...
     */
    public void setLoadMoreView(com.hebin.adapter.loadmore.LoadMoreView loadingView) {
    ...
    public void loadMoreEnd(boolean gone) {
        ...
        if (gone) {
            ...
            mLoadMoreView.setLoadMoreStatus(com.hebin.adapter.loadmore.LoadMoreView.STATUS_END);
    ...
    public void loadMoreComplete() {
        ...
        mLoading = false;
        mNextLoadEnable = true;
        mLoadMoreView.setLoadMoreStatus(com.hebin.adapter.loadmore.LoadMoreView.STATUS_DEFAULT);
        notifyItemChanged(getLoadMoreViewPosition());
    }
    ...
    public void loadMoreFail() {
        ...
        mLoading = false;
        mLoadMoreView.setLoadMoreStatus(com.hebin.adapter.loadmore.LoadMoreView.STATUS_FAIL);
        notifyItemChanged(getLoadMoreViewPosition());
    }
    ...
    private K getLoadingView(ViewGroup parent) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mLoadMoreView.getLoadMoreStatus() == com.hebin.adapter.loadmore.LoadMoreView.STATUS_FAIL) {
                    notifyLoadMoreToLoading();
                }
                if (mEnableLoadMoreEndClick && mLoadMoreView.getLoadMoreStatus() == com.hebin.adapter.loadmore.LoadMoreView.STATUS_END) {
                    notifyLoadMoreToLoading();
                }
            }
        });
    ...
    public void notifyLoadMoreToLoading() {
        if (mLoadMoreView.getLoadMoreStatus() == com.hebin.adapter.loadmore.LoadMoreView.STATUS_LOADING) {
            return;
        }
        mLoadMoreView.setLoadMoreStatus(com.hebin.adapter.loadmore.LoadMoreView.STATUS_DEFAULT);
        notifyItemChanged(getLoadMoreViewPosition());
    ...
    private com.hebin.adapter.util.MultiTypeDelegate<T> mMultiTypeDelegate;

    public void setMultiTypeDelegate(com.hebin.adapter.util.MultiTypeDelegate<T> multiTypeDelegate) {
        mMultiTypeDelegate = multiTypeDelegate;
    }

    public com.hebin.adapter.util.MultiTypeDelegate<T> getMultiTypeDelegate() {
    ...
    private void autoLoadMore(int position) {
        ...
        if (mLoadMoreView.getLoadMoreStatus() != com.hebin.adapter.loadmore.LoadMoreView.STATUS_DEFAULT) {
            return;
        }
        mLoadMoreView.setLoadMoreStatus(com.hebin.adapter.loadmore.LoadMoreView.STATUS_LOADING);
        if (!mLoading) {
            mLoading = true;
            if (getRecyclerView() != null) {
    ...
    private void addAnimation(RecyclerView.ViewHolder holder) {
        if (mOpenAnimationEnable) {
            if (!mFirstOnlyEnable || holder.getLayoutPosition() > mLastPosition) {
                com.hebin.adapter.animation.BaseAnimation animation = null;
    ...
    public void openLoadAnimation(@AnimationType int animationType) {
        ...
        switch (animationType) {
            case ALPHAIN:
                mSelectAnimation = new com.hebin.adapter.animation.AlphaInAnimation();
                break;
            case SCALEIN:
                mSelectAnimation = new com.hebin.adapter.animation.ScaleInAnimation();
                break;
            case SLIDEIN_BOTTOM:
                mSelectAnimation = new com.hebin.adapter.animation.SlideInBottomAnimation();
                break;
            case SLIDEIN_LEFT:
                mSelectAnimation = new com.hebin.adapter.animation.SlideInLeftAnimation();
                break;
            case SLIDEIN_RIGHT:
                mSelectAnimation = new com.hebin.adapter.animation.SlideInRightAnimation();
                break;
            default:
                break;
        }
     ...
     */
    public void openLoadAnimation(com.hebin.adapter.animation.BaseAnimation animation) {
        this.mOpenAnimationEnable = true;
    ...
    private int recursiveExpand(int position, @NonNull List list) {
        ...
        for (int i = list.size() - 1; i >= 0; i--, pos--) {
            if (list.get(i) instanceof com.hebin.adapter.entity.IExpandable) {
                com.hebin.adapter.entity.IExpandable item = (com.hebin.adapter.entity.IExpandable) list.get(i);
    ...
    public int expand(@IntRange(from = 0) int position, boolean animate, boolean shouldNotify) {
        ...
        com.hebin.adapter.entity.IExpandable expandable = getExpandableItem(position);
        if (expandable == null) {
            return 0;
        }
...
//            subItemCount += list.size();
    ...
    private int recursiveCollapse(@IntRange(from = 0) int position) {
        ...
        com.hebin.adapter.entity.IExpandable expandable = (com.hebin.adapter.entity.IExpandable) item;
        int subItemCount = 0;
        if (expandable.isExpanded()) {
            ...
            for (int i = subItems.size() - 1; i >= 0; i--) {
                ...
                if (subItem instanceof com.hebin.adapter.entity.IExpandable) {
    ...
    private boolean hasSubItems(com.hebin.adapter.entity.IExpandable item) {
        if (item == null) {
            return false;
        }
    ...
    public boolean isExpandable(T item) {
        return item != null && item instanceof com.hebin.adapter.entity.IExpandable;
    }

    private com.hebin.adapter.entity.IExpandable getExpandableItem(int position) {
        T item = getItem(position);
        if (isExpandable(item)) {
            return (com.hebin.adapter.entity.IExpandable) item;
        } else {
            return null;
        }
    }
    ...
    public int getParentPosition(@NonNull T item) {
        ...
        int level;
        if (item instanceof com.hebin.adapter.entity.IExpandable) {
            level = ((com.hebin.adapter.entity.IExpandable) item).getLevel();
        } else {
        ...
        for (int i = position; i >= 0; i--) {
            T temp = mData.get(i);
            if (temp instanceof com.hebin.adapter.entity.IExpandable) {
                com.hebin.adapter.entity.IExpandable expandable = (com.hebin.adapter.entity.IExpandable) temp;

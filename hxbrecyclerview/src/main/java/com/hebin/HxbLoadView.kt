 ...
 * describe：
 */
class HxbLoadView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : FrameLayout(context, attrs, defStyleAttr), IBottomView {
    ...
    override fun onPullingUp(fraction: Float, maxBottomHeight: Float, bottomHeight: Float) {
        ...
        refreshArrow!!.rotation = fraction * bottomHeight / maxBottomHeight * 180
    }

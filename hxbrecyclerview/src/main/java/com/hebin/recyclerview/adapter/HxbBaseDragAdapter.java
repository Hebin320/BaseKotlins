...
import com.hebin.recyclerview.callback.OnItemDragListener;
 ...
 */
public abstract class HxbBaseDragAdapter<T> extends HxbBaseAdapter<T> {
    ...
    public HxbBaseDragAdapter(Context context, List<T> data) {
        super(context, data);
    }

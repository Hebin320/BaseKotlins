 ...
 */
public abstract class HxbBaseAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public HxbBaseAdapter(Context context) {
        this(context, null);
    }

    public HxbBaseAdapter(Context context, List<T> data) {
    ...
    public class OnItemChildClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (mChildClickListener != null)
                mChildClickListener.onItemChildClick(HxbBaseAdapter.this, v, mViewHolder.getLayoutPosition() - getHeaderViewCount() - 1);
        }
    }
    ...
    public class OnItemChildLongClickListener implements View.OnLongClickListener {
        ...
        public boolean onLongClick(View v) {
            if (mChildLongClickListener != null) {
                return mChildLongClickListener.onItemChildLongClick(HxbBaseAdapter.this, v, mViewHolder.getLayoutPosition() - getHeaderViewCount() - 1);
            }
            return false;
        }
    }
    ...
    public interface OnRecyclerViewItemChildClickListener {
        void onItemChildClick(HxbBaseAdapter adapter, View view, int position);
    }

    public interface OnRecyclerViewItemChildLongClickListener {
        boolean onItemChildLongClick(HxbBaseAdapter adapter, View view, int position);
    }

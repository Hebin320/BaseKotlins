package com.hebin.recyclerview.swipemenu;
...
import com.hebin.recyclerview.HxbRecyclerView;
 ...
 */
public class HxbSwipeMenuRecyclerView extends HxbRecyclerView {
    ...
    protected HxbSwipeMenuLayout mTouchView;
    ...
    public HxbSwipeMenuRecyclerView(Context context) {
		this(context, null);
	}

	public HxbSwipeMenuRecyclerView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

    public HxbSwipeMenuRecyclerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action & MotionEventCompat.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (view instanceof HxbSwipeMenuLayout) {
                    mTouchView = (HxbSwipeMenuLayout) view;
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(isOutDuration || isOutX || isOutY){
                    ...
                    if(upView instanceof HxbSwipeMenuLayout){
                        HxbSwipeMenuLayout smView = (HxbSwipeMenuLayout)upView;
     ...
     */
    public HxbSwipeMenuLayout getTouchView() {
        return mTouchView;
    }

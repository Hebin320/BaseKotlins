...
import com.hebin.recyclerview.R;
 ...
 */
public class HxbSwipeMenuLayout extends FrameLayout {
	...
	public HxbSwipeMenuLayout(Context context) {
		this(context, null);
	}

	public HxbSwipeMenuLayout(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public HxbSwipeMenuLayout(Context context, AttributeSet attrs, int defStyle) {
	...
	private void swipe(int dis) {
		...
		if (mSwipeDirection == HxbSwipeMenuRecyclerView.DIRECTION_LEFT) {

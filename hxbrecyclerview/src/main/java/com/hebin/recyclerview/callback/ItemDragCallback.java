package com.hebin.recyclerview.callback;
...
import com.hebin.recyclerview.adapter.HxbBaseDragAdapter;
...
//    private static final String TAG = ItemDragCallback.class.getSimpleName();
    ...
    public ItemDragCallback(HxbBaseDragAdapter adapter) {
        mAdapter = adapter;
    }
    ...
    private boolean isViewCreateByAdapter(RecyclerView.ViewHolder viewHolder) {
        ...
        if (type == HxbBaseAdapter.VIEW_TYPE.HEADER || type == HxbBaseAdapter.VIEW_TYPE.FOOTER) {
            return true;
        }
        return false;

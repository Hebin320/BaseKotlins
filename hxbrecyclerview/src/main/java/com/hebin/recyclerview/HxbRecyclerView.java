package com.hebin.recyclerview;
...
public class HxbRecyclerView extends RecyclerView {
    ...
    public HxbRecyclerView(Context context) {
        this(context, null);
    }

    public HxbRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HxbRecyclerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        ((LoadingMoreFooter) mLoadMoreFootView).setNoMoreView(null);
    }
    ...
    public void setNomoreView(View view) {
        ...
        mLoadMoreFootView = footView;
        mLoadMoreFootView.setVisibility(GONE);
        ((LoadingMoreFooter) mLoadMoreFootView).setNoMoreView(view);
    }
        ...
        public void onChanged() {
            ...
            if (adapter != null && mEmptyView != null) {
                ...
                if (adapter.getItemCount() == emptyCount) {
                    ...
                    HxbRecyclerView.this.setVisibility(View.GONE);
                } else {
                    mEmptyView.setVisibility(View.GONE);
                    HxbRecyclerView.this.setVisibility(View.VISIBLE);
                }
            }
